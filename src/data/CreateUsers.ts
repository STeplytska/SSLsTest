import {data} from 'src/data/DataProvider';
...
export const userWithEmptyCredentials = new User('', '',
                                                data.messageWithEmptyEmail, data.messageWithEmptyPassword);
export const userNotRegistered = new User(data.notRegisterEmail, data.inValidPassword,
                                                data.messageNotRegisteredUser, '');
